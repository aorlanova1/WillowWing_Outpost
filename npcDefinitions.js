...
function createNPCs() {
    ...
    var anna = new classDefinitions.NPC("anna", ["Hey.", "Can I help you?"],["Hey, dude!"],["Happy you're here!"],[damon],[eightball],gameImages.annaIcon,worldMapsStore.mapSevenVillage, 3,2,[annaQuest1,annaQuest2, annaQuest3]);
    ...
    var eightball = new classDefinitions.NPC("eightball", ["You stick your nose in everyone's bizness?"],["Sup dopie."],["You're not one to just write people off, are you?"],[],[anna],gameImages.eightballIcon,worldMapsStore.mapSevenVillage, 7,2,[eightballQuest1]);
    ...
    var damon = new classDefinitions.NPC('damon', ["How's farm life treating you?", "Any nasty falls lately?"],["The weather, nice, eh?."],["You've been great to us."],[anna],[eightball],gameImages.cactus.src,worldMapsStore.mapSevenVillage,11,2,[damonShop1]);
